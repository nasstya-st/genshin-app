...
Boss_tals = enum.Enum(
	...
	names=(
		...
		" signora_butterfly signora_heart")
	)
...
all_weap = {"Skyward_Blade": Weapon(5, Asc_weap.boreal, Enemies_elite.ley_line, Enemies_gen.slime),
			...
			"Royal_Longsword": Weapon(4, Asc_weap.decarabian, Enemies_elite.hilichurl_horn,
...
resources_clear = {
	...
	'maguu_kenki': 0, 'mech_array': 0, 'electro_oceanid': 0, 'wolflord': 0, 'coral_defenders': 0,
